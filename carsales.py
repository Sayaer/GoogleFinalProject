...
def process_data(data):
  ...
  """
    ...
    for item in data:
        ...
        most_popular = max(all_values)
        most_popular_key = max(best_car, key=best_car.get)

    # May need to add line breaks, going to test first
    summary = [
        "The {} generated the most revenue: ${}".format(
            format_car(max_revenue["car"]), max_revenue["revenue"]),
        "The {} had the most sales: {}".format(total_sales["car"]["car_model"], total_sales["total_sales"]),
        "The most popular year was {} with {} sales.".format(most_popular_key, most_popular),
    ]
...
def main(argv):
    ...
    data = load_data("/home/student-04-d0d4a3338d3c/car_sales.json")
    ...
    msg = email_generate("automation@example.com", "student-04-d0d4a3338d3c@example.com",
